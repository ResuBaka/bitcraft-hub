...
#[sats(crate = __lib)]
pub(super) struct PlayerDeathStartArgs {
...
pub struct PlayerDeathStartCallbackId(__sdk::CallbackId);

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `player_death_start`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait player_death_start {
    /// Request that the remote module invoke the reducer `player_death_start` to run as soon as possible.
    ///
...
impl player_death_start for super::RemoteReducers {
    ...
    fn remove_on_player_death_start(&self, callback: PlayerDeathStartCallbackId) {
        self.imp.remove_on_reducer("player_death_start", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `player_death_start`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_player_death_start {
    /// Set the call-reducer flags for the reducer `player_death_start` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn player_death_start(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_player_death_start for super::SetReducerFlags {
    fn player_death_start(&self, flags: __ws::CallReducerFlags) {
