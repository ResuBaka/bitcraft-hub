...
pub struct ImportSecondaryKnowledgeDescCallbackId(__sdk::CallbackId);
...
#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `import_secondary_knowledge_desc`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_import_secondary_knowledge_desc {
    /// Set the call-reducer flags for the reducer `import_secondary_knowledge_desc` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
