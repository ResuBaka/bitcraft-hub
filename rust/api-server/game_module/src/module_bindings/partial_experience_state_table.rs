...
///
/// Obtain a handle from the [`PartialExperienceStateTableAccess::partial_experience_state`] method on [`super::RemoteTables`],
/// like `ctx.db.partial_experience_state()`.
///
/// Users are encouraged not to explicitly reference this type,
/// but to directly chain method calls,
/// like `ctx.db.partial_experience_state().on_insert(...)`.
pub struct PartialExperienceStateTableHandle<'ctx> {
    imp: __sdk::TableHandle<PartialExperienceState>,
    ctx: std::marker::PhantomData<&'ctx super::RemoteTables>,
}

#[allow(non_camel_case_types)]
/// Extension trait for access to the table `partial_experience_state`.
///
/// Implemented for [`super::RemoteTables`].
pub trait PartialExperienceStateTableAccess {
    #[allow(non_snake_case)]
    /// Obtain a [`PartialExperienceStateTableHandle`], which mediates access to the table `partial_experience_state`.
...
pub struct PartialExperienceStateInitialCallbackId(__sdk::CallbackId);
pub struct PartialExperienceStateInsertCallbackId(__sdk::CallbackId);
pub struct PartialExperienceStateDeleteCallbackId(__sdk::CallbackId);
...
impl<'ctx> PartialExperienceStateTableHandle<'ctx> {
    ...
    pub fn on_initial(
        &self,
        callback: impl FnMut(&super::EventContext, &[PartialExperienceState]) + Send + 'static,
    ) -> PartialExperienceStateInitialCallbackId {
        PartialExperienceStateInitialCallbackId(self.imp.on_initial(callback))
    }

    /// Cancel a callback previously registered by [`Self::on_initial`].
    pub fn remove_on_initial(&self, callback: PartialExperienceStateInitialCallbackId) {
        self.imp.remove_on_initial(callback.0)
    }
}

impl<'ctx> __sdk::Table for PartialExperienceStateTableHandle<'ctx> {
    ...
    ) -> PartialExperienceStateInsertCallbackId {
        PartialExperienceStateInsertCallbackId(self.imp.on_insert(Box::new(callback)))
    }

    fn remove_on_insert(&self, callback: PartialExperienceStateInsertCallbackId) {
        self.imp.remove_on_insert(callback.0)
    }

    type DeleteCallbackId = PartialExperienceStateDeleteCallbackId;

    fn on_delete(
        &self,
        callback: impl FnMut(&Self::EventContext, &Self::Row) + Send + 'static,
    ) -> PartialExperienceStateDeleteCallbackId {
        PartialExperienceStateDeleteCallbackId(self.imp.on_delete(Box::new(callback)))
    }

    fn remove_on_delete(&self, callback: PartialExperienceStateDeleteCallbackId) {
...
impl<'ctx> __sdk::TableWithPrimaryKey for PartialExperienceStateTableHandle<'ctx> {
    type UpdateCallbackId = PartialExperienceStateUpdateCallbackId;

    fn on_update(
        &self,
        callback: impl FnMut(&Self::EventContext, &Self::Row, &Self::Row) + Send + 'static,
    ) -> PartialExperienceStateUpdateCallbackId {
        PartialExperienceStateUpdateCallbackId(self.imp.on_update(Box::new(callback)))
    }

    fn remove_on_update(&self, callback: PartialExperienceStateUpdateCallbackId) {
