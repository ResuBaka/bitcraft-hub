...
pub struct CraftCollectCallbackId(__sdk::CallbackId);
...
impl craft_collect for super::RemoteReducers {
    ...
    fn remove_on_craft_collect(&self, callback: CraftCollectCallbackId) {
        self.imp.remove_on_reducer("craft_collect", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `craft_collect`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_craft_collect {
    /// Set the call-reducer flags for the reducer `craft_collect` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn craft_collect(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_craft_collect for super::SetReducerFlags {
    fn craft_collect(&self, flags: __ws::CallReducerFlags) {
