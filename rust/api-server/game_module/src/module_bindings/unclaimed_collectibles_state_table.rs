...
pub struct UnclaimedCollectiblesStateInitialCallbackId(__sdk::CallbackId);
...
impl<'ctx> UnclaimedCollectiblesStateTableHandle<'ctx> {
    ...
    pub fn on_initial(
        &self,
        callback: impl FnMut(&super::EventContext, &[UnclaimedCollectiblesState]) + Send + 'static,
    ) -> UnclaimedCollectiblesStateInitialCallbackId {
        UnclaimedCollectiblesStateInitialCallbackId(self.imp.on_initial(callback))
    }

    /// Cancel a callback previously registered by [`Self::on_initial`].
    pub fn remove_on_initial(&self, callback: UnclaimedCollectiblesStateInitialCallbackId) {
...
impl<'ctx> __sdk::Table for UnclaimedCollectiblesStateTableHandle<'ctx> {
    ...
    __sdk::__if_client_cache! {
        ...
        fn iter(&self) -> impl Iterator<Item = UnclaimedCollectiblesState> + '_ { self.imp.iter() }
    }
...
pub(super) fn register_table(client_cache: &mut __sdk::ClientCache<super::RemoteModule>) {
        ...
        let _table = client_cache.get_or_make_table::<UnclaimedCollectiblesState>("unclaimed_collectibles_state");
