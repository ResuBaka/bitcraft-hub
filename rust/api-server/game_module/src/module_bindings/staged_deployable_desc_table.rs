...
pub struct StagedDeployableDescInitialCallbackId(__sdk::CallbackId);
...
impl<'ctx> StagedDeployableDescTableHandle<'ctx> {
    ...
    ) -> StagedDeployableDescInitialCallbackId {
        StagedDeployableDescInitialCallbackId(self.imp.on_initial(callback))
    }

    /// Cancel a callback previously registered by [`Self::on_initial`].
    pub fn remove_on_initial(&self, callback: StagedDeployableDescInitialCallbackId) {
...
impl<'ctx> StagedDeployableDescTableHandle<'ctx> {
    ...
    pub fn deploy_from_collectible_id(&self) -> StagedDeployableDescDeployFromCollectibleIdUnique<'ctx> {
