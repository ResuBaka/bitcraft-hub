...
pub struct StageSkillDescCallbackId(__sdk::CallbackId);
...
impl stage_skill_desc for super::RemoteReducers {
    ...
    fn remove_on_stage_skill_desc(&self, callback: StageSkillDescCallbackId) {
        self.imp.remove_on_reducer("stage_skill_desc", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `stage_skill_desc`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_stage_skill_desc {
    /// Set the call-reducer flags for the reducer `stage_skill_desc` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn stage_skill_desc(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_stage_skill_desc for super::SetReducerFlags {
    fn stage_skill_desc(&self, flags: __ws::CallReducerFlags) {
