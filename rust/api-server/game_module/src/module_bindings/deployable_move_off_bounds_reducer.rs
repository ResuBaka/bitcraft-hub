...
pub struct DeployableMoveOffBoundsCallbackId(__sdk::CallbackId);
...
#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `deployable_move_off_bounds`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_deployable_move_off_bounds {
    /// Set the call-reducer flags for the reducer `deployable_move_off_bounds` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
