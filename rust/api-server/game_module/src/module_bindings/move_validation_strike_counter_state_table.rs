...
///
/// Obtain a handle from the [`MoveValidationStrikeCounterStateTableAccess::move_validation_strike_counter_state`] method on [`super::RemoteTables`],
/// like `ctx.db.move_validation_strike_counter_state()`.
///
/// Users are encouraged not to explicitly reference this type,
/// but to directly chain method calls,
/// like `ctx.db.move_validation_strike_counter_state().on_insert(...)`.
pub struct MoveValidationStrikeCounterStateTableHandle<'ctx> {
    imp: __sdk::TableHandle<MoveValidationStrikeCounterState>,
    ctx: std::marker::PhantomData<&'ctx super::RemoteTables>,
}

#[allow(non_camel_case_types)]
/// Extension trait for access to the table `move_validation_strike_counter_state`.
///
...
pub struct MoveValidationStrikeCounterStateInitialCallbackId(__sdk::CallbackId);
pub struct MoveValidationStrikeCounterStateInsertCallbackId(__sdk::CallbackId);
pub struct MoveValidationStrikeCounterStateDeleteCallbackId(__sdk::CallbackId);
...
impl<'ctx> MoveValidationStrikeCounterStateTableHandle<'ctx> {
    ...
    pub fn on_initial(
        &self,
        callback: impl FnMut(&super::EventContext, &[MoveValidationStrikeCounterState]) + Send + 'static,
    ) -> MoveValidationStrikeCounterStateInitialCallbackId {
        MoveValidationStrikeCounterStateInitialCallbackId(self.imp.on_initial(callback))
    }

    /// Cancel a callback previously registered by [`Self::on_initial`].
    pub fn remove_on_initial(&self, callback: MoveValidationStrikeCounterStateInitialCallbackId) {
        self.imp.remove_on_initial(callback.0)
    }
}

impl<'ctx> __sdk::Table for MoveValidationStrikeCounterStateTableHandle<'ctx> {
    ...
    ) -> MoveValidationStrikeCounterStateInsertCallbackId {
        MoveValidationStrikeCounterStateInsertCallbackId(self.imp.on_insert(Box::new(callback)))
    }

    fn remove_on_insert(&self, callback: MoveValidationStrikeCounterStateInsertCallbackId) {
        self.imp.remove_on_insert(callback.0)
    }

    type DeleteCallbackId = MoveValidationStrikeCounterStateDeleteCallbackId;

    fn on_delete(
        &self,
        callback: impl FnMut(&Self::EventContext, &Self::Row) + Send + 'static,
    ) -> MoveValidationStrikeCounterStateDeleteCallbackId {
        MoveValidationStrikeCounterStateDeleteCallbackId(self.imp.on_delete(Box::new(callback)))
    }

    fn remove_on_delete(&self, callback: MoveValidationStrikeCounterStateDeleteCallbackId) {
...
impl<'ctx> __sdk::TableWithPrimaryKey for MoveValidationStrikeCounterStateTableHandle<'ctx> {
    type UpdateCallbackId = MoveValidationStrikeCounterStateUpdateCallbackId;

    fn on_update(
        &self,
        callback: impl FnMut(&Self::EventContext, &Self::Row, &Self::Row) + Send + 'static,
    ) -> MoveValidationStrikeCounterStateUpdateCallbackId {
        MoveValidationStrikeCounterStateUpdateCallbackId(self.imp.on_update(Box::new(callback)))
    }

    fn remove_on_update(&self, callback: MoveValidationStrikeCounterStateUpdateCallbackId) {
...
) -> __sdk::Result<__sdk::TableUpdate<MoveValidationStrikeCounterState>> {
