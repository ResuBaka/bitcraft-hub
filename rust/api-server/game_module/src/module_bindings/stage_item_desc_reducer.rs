...
pub struct StageItemDescCallbackId(__sdk::CallbackId);
...
impl stage_item_desc for super::RemoteReducers {
    ...
    fn remove_on_stage_item_desc(&self, callback: StageItemDescCallbackId) {
        self.imp.remove_on_reducer("stage_item_desc", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `stage_item_desc`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_stage_item_desc {
    /// Set the call-reducer flags for the reducer `stage_item_desc` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn stage_item_desc(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_stage_item_desc for super::SetReducerFlags {
    fn stage_item_desc(&self, flags: __ws::CallReducerFlags) {
