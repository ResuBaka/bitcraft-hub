...
pub struct AttackImpactCallbackId(__sdk::CallbackId);
...
impl attack_impact for super::RemoteReducers {
    ...
    fn remove_on_attack_impact(&self, callback: AttackImpactCallbackId) {
        self.imp.remove_on_reducer("attack_impact", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `attack_impact`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_attack_impact {
    /// Set the call-reducer flags for the reducer `attack_impact` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn attack_impact(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_attack_impact for super::SetReducerFlags {
    fn attack_impact(&self, flags: __ws::CallReducerFlags) {
