...
#[allow(non_camel_case_types)]
/// Extension trait for query builder access to the table `DeployableCollectibleStateV2`.
///
/// Implemented for [`__sdk::QueryTableAccessor`].
pub trait deployable_collectible_state_v2QueryTableAccess {
    #[allow(non_snake_case)]
    /// Get a query builder for the table `DeployableCollectibleStateV2`.
    fn deployable_collectible_state_v2(
        &self,
    ) -> __sdk::__query_builder::Table<DeployableCollectibleStateV2>;
}

impl deployable_collectible_state_v2QueryTableAccess for __sdk::QueryTableAccessor {
    fn deployable_collectible_state_v2(
        &self,
    ) -> __sdk::__query_builder::Table<DeployableCollectibleStateV2> {
        __sdk::__query_builder::Table::new("deployable_collectible_state_v2")
    }
}
