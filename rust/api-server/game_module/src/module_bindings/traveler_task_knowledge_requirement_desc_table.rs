...
pub struct TravelerTaskKnowledgeRequirementDescInitialCallbackId(__sdk::CallbackId);
...
impl<'ctx> TravelerTaskKnowledgeRequirementDescTableHandle<'ctx> {
    ...
    pub fn on_initial(
        ...
        + Send
        + 'static,
    ) -> TravelerTaskKnowledgeRequirementDescInitialCallbackId {
        TravelerTaskKnowledgeRequirementDescInitialCallbackId(self.imp.on_initial(callback))
    }

    /// Cancel a callback previously registered by [`Self::on_initial`].
    pub fn remove_on_initial(
        &self,
        callback: TravelerTaskKnowledgeRequirementDescInitialCallbackId,
    ) {
