...
pub struct ImportHerdCacheCallbackId(__sdk::CallbackId);
...
impl import_herd_cache for super::RemoteReducers {
    ...
    fn remove_on_import_herd_cache(&self, callback: ImportHerdCacheCallbackId) {
        self.imp.remove_on_reducer("import_herd_cache", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `import_herd_cache`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_import_herd_cache {
    /// Set the call-reducer flags for the reducer `import_herd_cache` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn import_herd_cache(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_import_herd_cache for super::SetReducerFlags {
    fn import_herd_cache(&self, flags: __ws::CallReducerFlags) {
