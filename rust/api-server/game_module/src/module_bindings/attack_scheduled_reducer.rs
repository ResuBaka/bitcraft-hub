...
pub struct AttackScheduledCallbackId(__sdk::CallbackId);
...
impl attack_scheduled for super::RemoteReducers {
    ...
    fn remove_on_attack_scheduled(&self, callback: AttackScheduledCallbackId) {
        self.imp.remove_on_reducer("attack_scheduled", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `attack_scheduled`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_attack_scheduled {
    /// Set the call-reducer flags for the reducer `attack_scheduled` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn attack_scheduled(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_attack_scheduled for super::SetReducerFlags {
    fn attack_scheduled(&self, flags: __ws::CallReducerFlags) {
