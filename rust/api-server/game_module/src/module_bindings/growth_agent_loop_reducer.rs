...
pub struct GrowthAgentLoopCallbackId(__sdk::CallbackId);
...
impl growth_agent_loop for super::RemoteReducers {
    ...
    fn remove_on_growth_agent_loop(&self, callback: GrowthAgentLoopCallbackId) {
        self.imp.remove_on_reducer("growth_agent_loop", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `growth_agent_loop`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_growth_agent_loop {
    /// Set the call-reducer flags for the reducer `growth_agent_loop` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn growth_agent_loop(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_growth_agent_loop for super::SetReducerFlags {
    fn growth_agent_loop(&self, flags: __ws::CallReducerFlags) {
