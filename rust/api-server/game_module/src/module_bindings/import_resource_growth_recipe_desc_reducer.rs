...
pub struct ImportResourceGrowthRecipeDescCallbackId(__sdk::CallbackId);
...
#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `import_resource_growth_recipe_desc`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_import_resource_growth_recipe_desc {
    /// Set the call-reducer flags for the reducer `import_resource_growth_recipe_desc` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
