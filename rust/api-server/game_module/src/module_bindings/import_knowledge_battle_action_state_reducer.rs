...
pub struct ImportKnowledgeBattleActionStateCallbackId(__sdk::CallbackId);
...
#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `import_knowledge_battle_action_state`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_import_knowledge_battle_action_state {
    /// Set the call-reducer flags for the reducer `import_knowledge_battle_action_state` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
