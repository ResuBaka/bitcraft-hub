...
pub struct AutoLogoutLoopCallbackId(__sdk::CallbackId);
...
impl auto_logout_loop for super::RemoteReducers {
    ...
    fn remove_on_auto_logout_loop(&self, callback: AutoLogoutLoopCallbackId) {
        self.imp.remove_on_reducer("auto_logout_loop", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `auto_logout_loop`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_auto_logout_loop {
    /// Set the call-reducer flags for the reducer `auto_logout_loop` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn auto_logout_loop(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_auto_logout_loop for super::SetReducerFlags {
    fn auto_logout_loop(&self, flags: __ws::CallReducerFlags) {
