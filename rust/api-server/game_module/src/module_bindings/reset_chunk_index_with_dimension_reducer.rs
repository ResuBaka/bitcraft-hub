...
pub struct ResetChunkIndexWithDimensionCallbackId(__sdk::CallbackId);
...
#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `reset_chunk_index_with_dimension`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_reset_chunk_index_with_dimension {
    /// Set the call-reducer flags for the reducer `reset_chunk_index_with_dimension` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
