...
pub struct ClaimAddTileCallbackId(__sdk::CallbackId);
...
impl claim_add_tile for super::RemoteReducers {
    ...
    fn remove_on_claim_add_tile(&self, callback: ClaimAddTileCallbackId) {
        self.imp.remove_on_reducer("claim_add_tile", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `claim_add_tile`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_claim_add_tile {
    /// Set the call-reducer flags for the reducer `claim_add_tile` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn claim_add_tile(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_claim_add_tile for super::SetReducerFlags {
    fn claim_add_tile(&self, flags: __ws::CallReducerFlags) {
