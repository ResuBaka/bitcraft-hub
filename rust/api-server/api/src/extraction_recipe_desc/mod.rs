...
pub(crate) struct ExtractionRecipeResponse {
    pub id: i32,
    pub resource_id: i32,
    pub extracted_item_stacks: Vec<entity::shared::probabilistic_item_stack::ProbabilisticItemStack>,
...
pub(crate) async fn get_all(
    ...
    let recipes = QueryCore::all_extraction_recipe_desc(&state.conn)
        .await
        .map_err(|_| (StatusCode::INTERNAL_SERVER_ERROR, "Cannot find extraction recipes"))?;
