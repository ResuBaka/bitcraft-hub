...
pub struct AchievementClaimCallbackId(__sdk::CallbackId);
...
impl achievement_claim for super::RemoteReducers {
    ...
    fn remove_on_achievement_claim(&self, callback: AchievementClaimCallbackId) {
        self.imp.remove_on_reducer("achievement_claim", callback.0)
    }
}

#[allow(non_camel_case_types)]
#[doc(hidden)]
/// Extension trait for setting the call-flags for the reducer `achievement_claim`.
///
/// Implemented for [`super::SetReducerFlags`].
///
/// This type is currently unstable and may be removed without a major version bump.
pub trait set_flags_for_achievement_claim {
    /// Set the call-reducer flags for the reducer `achievement_claim` to `flags`.
    ///
    /// This type is currently unstable and may be removed without a major version bump.
    fn achievement_claim(&self, flags: __ws::CallReducerFlags);
}

impl set_flags_for_achievement_claim for super::SetReducerFlags {
    fn achievement_claim(&self, flags: __ws::CallReducerFlags) {
