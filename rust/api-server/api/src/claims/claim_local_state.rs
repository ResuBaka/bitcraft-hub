...
// }
//
// async fn known_claim_local_state_ids(conn: &DatabaseConnection) -> anyhow::Result<HashSet<i64>> {
...
//         .filter(claim_local_state::Column::EntityId.is_in(known_claim_ids.clone()))
//         .exec(conn)
//         .await?;
//
//     Ok(())
