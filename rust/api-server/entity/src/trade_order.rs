...
//             remaining_stock: value.remaining_stock.into_iter().map(|required_item| ItemStack {
...
//             }),
//             offer_items: value.offer_items,
//             offer_cargo_id: value.offer_cargo_id,
//             required_items: value.required_items.into_iter().map(|required_item| ItemStack {
//                 item_id: required_item.item_id,
//                 quantity: required_item.quantity,
//                 item_type: required_item.item_type.into(),
//                 durability: required_item.durability,
