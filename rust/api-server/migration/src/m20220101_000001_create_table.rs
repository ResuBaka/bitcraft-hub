...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Location::ChunkIndex)
                            .big_integer()
                            .not_null(),
                    )
            ...
            .await
            .expect("Creating Location table");
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(PlayerState::UnmannedVehicleCoords)
                            .json()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(PlayerState::DestinationMarker)
                            .json()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(PlayerState::FavoriteCraftingRecipes)
                            .json()
                            .not_null(),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new(PlayerState::AccessLevel)
                            .integer()
                            .not_null(),
                    )
                    .col(
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(CraftingRecipe::TimeRequirement)
                            .integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::StaminaRequirement)
                            .integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::BuildingRequirement)
                            .json()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::LevelRequirements)
                            .json()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::ToolRequirements)
                            .json()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::ConsumedItemStacks)
                            .json()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::DiscoveryTriggers)
                            .json()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::RequiredKnowledges)
                            .json()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::RequiredClaimTechId)
                            .json()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::FullDiscoveryScore)
                            .integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::CompletionExperience)
                            .json()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::AllowUseHands)
                            .boolean()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::CraftedItemStacks)
                            .json()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::IsPassive)
                            .boolean()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::ActionsRequired)
                            .integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::ToolMeshIndex)
                            .integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::AnimationStart)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CraftingRecipe::AnimationEnd)
                            .string()
                            .not_null(),
                    )
                    .to_owned(),
        ...
        manager
            ...
            .await
            .expect("Creating SkillDesc table");
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(TradeOrder::BuildingEntityId)
                            .big_integer()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(TradeOrder::RequiredCargoId)
                            .json()
                            .not_null(),
                    )
                    .to_owned(),
            ...
            .await
            .expect("Creating TradeOrder table");
        ...
        manager
            ...
            .await
            .expect("Creating UserState table");
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Item::SecondaryKnowledgeId)
                            .integer()
                            .not_null(),
                    )
        ...
        manager
            ...
            .await
            .expect("Creating Equipment table");
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(ClaimDescription::OwnerPlayerEntityId)
                            .big_integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(ClaimDescription::OwnerBuildingEntityId)
                            .big_integer()
                            .not_null(),
                    )
                    .col(ColumnDef::new(ClaimDescription::Name).string().not_null())
                    .col(
                        ColumnDef::new(ClaimDescription::Supplies)
                            .float()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(ClaimDescription::BuildingMaintenance)
                            .float()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(ClaimDescription::Extensions)
                            .integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(ClaimDescription::Neutral)
                            .boolean()
                            .not_null(),
                    )
                    .col(ColumnDef::new(ClaimDescription::Location).json().not_null())
                    .col(
                        ColumnDef::new(ClaimDescription::Treasury)
                            .integer()
                            .not_null(),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(CargoState::SpawnTimestamp)
                            .integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoState::DescriptionId)
                            .integer()
                            .not_null(),
                    )
            ...
            .await
            .expect("Creating CargoState table");
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(CargoDescription::Description)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::Volume)
                            .integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::SecondaryKnowledgeId)
                            .integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::ModelAssetName)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::IconAssetName)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::CarriedModelAssetName)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::PickUpAnimationStart)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::PickUpAnimationEnd)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::DropAnimationStart)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::DropAnimationEnd)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::PickUpTime)
                            .float()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::PlaceTime)
                            .float()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::AnimatorState)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::MovementModifier)
                            .float()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::BlocksPath)
                            .boolean()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::OnDestroyYieldCargos)
                            .json()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(CargoDescription::DespawnTime)
                            .float()
                            .not_null(),
                    )
        ...
        manager
            .create_index(
                Index::create()
                    .name("building_state_building_description_id")
                    .table(BuildingState::Table)
                    .col(BuildingState::BuildingDescriptionId)
                    .to_owned(),
            )
            .await
            .expect("Creating building_state_building_description_id index");

        manager
            .create_index(
                Index::create()
                    .name("building_state_building_description_id_claim_entity_id")
                    .table(BuildingState::Table)
                    .col(BuildingState::BuildingDescriptionId)
                    .col(BuildingState::ClaimEntityId)
                    .to_owned(),
            ...
            .await
            .expect("Creating building_state_building_description_id_claim_entity_id index");
