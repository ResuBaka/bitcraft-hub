    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(ClaimDescription::Supplies).float().not_null())
                .col(ColumnDef::new(ClaimDescription::BuildingMaintenance).float().not_null())
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(CargoDescription::PickUpTime).float().not_null())
                .col(ColumnDef::new(CargoDescription::PlaceTime).float().not_null())
                .col(ColumnDef::new(CargoDescription::AnimatorState).string().not_null())
                .col(ColumnDef::new(CargoDescription::MovementModifier).float().not_null())
                ...
                .col(ColumnDef::new(CargoDescription::DespawnTime).float().not_null())
