import { getBuildingRequirement, updateBuildingRequirement } from "~/logic";
...
export default defineEventHandler(async (event) => {
  ...
  const building = getBuildingRequirement(id, requirementId);
  ...
  await updateBuildingRequirement(id, result.data);
